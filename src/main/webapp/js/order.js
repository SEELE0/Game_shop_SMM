$(function () {
    ...
    function get_orders(pages) { //获取订单
        $.ajax({
    ...
    function orderlist(arry) {
        for (var i in arry) {
            ...
            str += "<li class='col01'><img src='../images/cart_order.jpg '></li>"
            // str += "<li className='col01'><img src='../images/" + arry[i]["goods_img"] + "'></li>"
