...
<body>
	...
	<div class="center_con clearfix">
		<ul class="subnav fl">
			<li><a href="#model01" class="props">道具</a></li>
			<li><a href="#model02" class="pet">饰品</a></li>
			<li><a href="#model03" class="dlc">扩展DLC</a></li>
			<li><a href="#model04" class="props">道具</a></li>
			<li><a href="#model05" class="pet">饰品</a></li>
			<li><a href="#model06" class="dlc">扩展DLC</a></li>
		</ul>
		<div class="slide fl">
			<ul class="slide_pics">
