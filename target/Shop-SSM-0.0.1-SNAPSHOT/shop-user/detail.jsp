...
<body>
	...
	<div class="navbar_con">
		<div class="navbar clearfix">
			<div class="subnav_con fl">
				...
				<span></span>			
				<ul class="subnav">
					<li><a href="#" class="props">道具</a></li>
					<li><a href="#" class="pet">饰品</a></li>
					<li><a href="#" class="dlc">扩展DLC</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	function  lists(arry) {
		...
		str+="<span class='show_unit' id='show_unit'>类别：<em id='showun'>"+arry["goods_unit"]+"</em></span>"
